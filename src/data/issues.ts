...
export const accessibilityIssues: AccessibilityIssue[] = [
  {
    ...
    beforeFix: '<img src="/api/placeholder/400/300" class="hero-image">',
    afterFix: '<img src="/api/placeholder/400/300" alt="Students collaborating on accessibility testing in a modern computer lab" class="hero-image">'
  },
  {
